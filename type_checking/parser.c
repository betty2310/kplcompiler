...
Type* compileLValue(void) {
    // TODO: parse a lvalue (a variable, an array element, a parameter, the current function
    // identifier)
    // DONE
    Object* var;
    Type* varType;
...
void compileArgument(Object* param) {
    ...
    Type* expressType = (Type*) malloc(sizeof(Type));
    expressType = compileExpression();
    checkTypeEquality(expressType, param->paramAttrs->type);
}

void compileArguments(ObjectNode* paramList) {
    // TODO: parse a list of arguments, check the consistency of the arguments and the given
    // parameters
    // DONE
...
void compileCondition(void) {
    ...
    // DONE
    Type* leftExpressType = (Type*) malloc(sizeof(Type));
    leftExpressType = compileExpression();
    ...
    checkTypeEquality(leftExpressType, compileExpression());
}
